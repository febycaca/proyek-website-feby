...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    ...
    >
      {children}
      <ChevronDown className="h-4 w-4 shrink-0 text-pink-400 transition-transform duration-200" />
    </AccordionPrimitive.Trigger>
...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Content
    ref={ref}
    className="overflow-hidden text-sm transition-all data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down text-gray-600 dark:text-pink-200/80"
    {...props}
  >
